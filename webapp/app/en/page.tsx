...
const tools = [
  { icon: TrendingUp, name: 'Vocabulary Diagnosis', desc: 'Identifies your gaps and builds a personalized 3,000-word study plan.' },
  { icon: Film, name: 'Subtitle Series', desc: 'Study with TV episodes matched to your level, with vocabulary pre-loaded.' },
  { icon: Headphones, name: 'AudioBook', desc: 'Guided audiobook library (Lit2Go), level-matched, with mapped vocabulary.' },
  { icon: Bot, name: 'AI Prompt Simulator', desc: 'Generates ChatGPT prompts to simulate interviews, meetings, daily standups in English.' },
]
        ...
        <section id="tools" className="section-padding bg-dark-secondary border-y border-dark-border">
          <div className="container mx-auto px-4">
            ...
            <p className="text-center text-gray-500 text-sm mt-8">
              + 6 more tools (smart revision, journal, audio hub, gamification, personalized materials, recommendation system)
            </p>
          </div>
        </section>
